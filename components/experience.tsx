  ...
  return (
    <section id="experiencia" className="section-space scroll-mt-16">
      <div className="container-shell">
        <Reveal><SectionHeading number="05" label="EXPERIÊNCIA" title="Experiência profissional" /></Reveal>
        <Reveal>
          <article className="grid gap-7 border-y border-border py-9 md:grid-cols-[170px_1fr] md:gap-12 md:py-12">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-3 font-medium">Secretaria Municipal de Inovação e Tecnologia da Cidade de Salvador — SEMIT</p>
