  ...
  return (
    <header
      className={cn(
        ...
        scrolled &&
          !open &&
          "border-b border-border/80 bg-background/95 backdrop-blur-xl",
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="ml-3 hidden border-l border-border pl-3 text-xs font-medium tracking-normal text-muted-foreground sm:inline">
            Ravi Mariani
          </span>
        </a>
        ...
        <div className="relative z-[60] flex items-center gap-1">
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub de Ravi Mariani"
            >
          ...
          <div className="flex flex-col border-t border-border">
            {navigation.map((item, index) => (
              <a
                ...
                onClick={() => setOpen(false)}
                tabIndex={open ? 0 : -1}
                className="group flex min-h-16 items-center justify-between border-b border-border text-xl font-medium"
              >
                <span>
